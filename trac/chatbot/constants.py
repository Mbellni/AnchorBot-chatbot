...
Hello, I’m TRAC, your Tranquility, Reflection and Awareness Chatbot. [[pause=2]]
I’m here to help you find moments of calm and clarity. [[pause=2]]
Whether you’re feeling overwhelmed or just need to unwind a bit, these strategies can be a great way to restore balance. [[pause=3]]
{Style.RESET_ALL}"""
QUESTION_START = f"{Fore.GREEN}Shall we get started? Please type 'yes' or 'no'.\n{Style.RESET_ALL}"
EXIT_MESSAGE = f"""{Fore.GREEN}
That is alright. [[pause=1]] If you change your mind and want to give in to relaxation, I am a push of a button away. [[pause=2]] Hope to see you soon.
{Style.RESET_ALL}"""
...
# === Grounding ===
GROUNDING_INTRO = f"""{Fore.GREEN}Let’s try something a bit different instead. [[pause=2]]\nWe’ll move on to a grounding exercise that can help bring you into the present moment and find a sense of calm. [[pause=2]]\nThere is no pressure! You will have time to finish the exercise before moving on. If you feel more comfortable, wait until I finish naming all the steps. [[pause=3]]\n{Style.RESET_ALL}"""
...
# === Affirmations ===
POSITIVE_INTRO = f"""{Fore.GREEN}Now, let’s continue with some positive affirmations to uplift and encourage you. [[pause=2]] These can be a wonderful way to reinforce a sense of confidence. [[pause=2]]{Style.RESET_ALL}"""
AFFIRMATIONS_START_PROMPT = f"""{Fore.GREEN}Ready to give it a try? [[pause=1]] Please type \"start\" or \"skip\".\n{Style.RESET_ALL}"""
AFFIRMATIONS_LIST = f"""{Fore.GREEN}Here are a few affirmations for today. Repeat each one slowly to yourself, or let me know which resonates most: [[pause=3]]\n1 - “I am worthy of peace and calm.” [[pause=2]]\n2 - “I am doing my best, and that’s enough.” [[pause=2]]\n3 - “I am resilient, strong, and capable.” [[pause=2]]\n4 - “I trust myself to handle what comes my way.” [[pause=3]]{Style.RESET_ALL}"""
AFFIRMATION_CHOICE_PROMPT = f"{Fore.GREEN}Which one speaks to you most? Phrase 1, 2, 3 or 4?\n{Style.RESET_ALL}"
AFFIRMATION_RESPONSES = {
    "1": f"""{Fore.GREEN}Absolutely, you deserve all the peace and calm that life has to offer. [[pause=2]] Embracing that worthiness can be so empowering. [[pause=2]]{Style.RESET_ALL}""",
    "2": f"""{Fore.GREEN}That’s a beautiful reminder. [[pause=1]] Your best is more than enough, and honoring that can bring such a sense of relief. [[pause=2]]{Style.RESET_ALL}""",
    "3": f"""{Fore.GREEN}Yes! [[pause=1]] You have such strength within you. [[pause=1]] Remembering this can help you face any challenge that comes your way. [[pause=2]]{Style.RESET_ALL}""",
    "4": f"""{Fore.GREEN}Trusting yourself is so powerful. [[pause=1]] You’re capable and resilient, ready to face whatever comes. [[pause=2]]{Style.RESET_ALL}"""
}
POSITIVE_REINFORCEMENT = f"""{Fore.GREEN}Great job! [[pause=1]] Taking a moment to connect with yourself like this is a wonderful step. [[pause=2]]{Style.RESET_ALL}"""
CAFE_INTRO = f"""{Fore.GREEN}Now that we’ve set a positive foundation, let’s explore some cozy cafes where you can relax, reflect, or simply enjoy a peaceful moment. [[pause=3]]{Style.RESET_ALL}"""
CAFE_PRIVACY_NOTE = f"""{Fore.GREEN}Quick note: our cafe recommendations use a location-based search to find calming spots nearby, but rest assured, your location information is only used temporarily for this purpose and isn’t stored. [[pause=2]] Your privacy and confidentiality are always protected. [[pause=2]] Also, this task requires wifi connection. [[pause=3]]{Style.RESET_ALL}"""

# === Cafe Flow ===
CAFE_PROMPT = f"""{Fore.GREEN}Ready to find a cozy spot? Please type \"yes\" or \"conclude\".\n{Style.RESET_ALL}"""
CAFE_FOUND = f"{Fore.GREEN}\nI hope you found a cafe that piqued your interest! [[pause=2]]{Style.RESET_ALL}"
CAFE_NOT_FOUND = f"{Fore.GREEN}\nI'm sorry I couldn't find any cafes nearby. [[pause=2]]{Style.RESET_ALL}"
CAFE_CONCLUDE_TEXT = f"""{Fore.GREEN}Thank you for spending this time with me today. [[pause=2]]\nI hope the techniques we explored bring you some calm and comfort. [[pause=3]]{Style.RESET_ALL}"""
